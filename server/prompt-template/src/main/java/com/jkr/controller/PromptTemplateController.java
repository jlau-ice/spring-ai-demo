...
public class PromptTemplateController {
    ...
    public Flux<String> chat(String topic, String outputFormat, String wordCount) {
        topic = topic == null ? "鬼" : topic;
        outputFormat = outputFormat == null ? "html" : outputFormat;
        wordCount = wordCount == null ? "300" : wordCount;
    ...
    public Flux<String> chat3(String sysTopic, String userTopic) {
        sysTopic = sysTopic == null ? "法律" : sysTopic;
        userTopic = userTopic == null ? "劳动法第57条" : userTopic;
    ...
    public Flux<String> chat4(String question) {
        question = question == null ? "讲个故事" : question;
        //1 系统消息
